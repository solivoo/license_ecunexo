...
public sealed class UpdateGrantTenantEntitlementsValidator
    : AbstractValidator<UpdateGrantTenantEntitlementsCommand>
{
    public UpdateGrantTenantEntitlementsValidator()
    {
